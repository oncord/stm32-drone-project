/*
 * This is a modified version of the library written for the ICM20602 to fit the functionality of the STM32F4. Only supports SPI.
 *
 * ICM20602-STM32F4-SPI-LL-Driver
 */
