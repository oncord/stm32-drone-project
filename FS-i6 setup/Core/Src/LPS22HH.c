/*
 * This is a modified version of the library written for the LPS22HH to fit the functionality of the STM32F4. Only supports SPI.
 *
 * LPS22HH-STM32F4-SPI-LL-Driver
 */
