/*
 * This is a modified version of the library written for the BNO080 to fit the functionality of the STM32F4. Only supports SPI.
 *
 * BNO080-STM32F4-SPI-LL-Driver
 */
